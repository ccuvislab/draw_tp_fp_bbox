...
def add_config(cfg):
    ...
    # 控制tp_fp_fn數量、bbox存取
    # ---------------------------------------------------------------------------- #
    _C.MODEL.SAVE_TP_FP_FN = False
    _C.MODEL.STORE_TP_FP_FN_ROOT_PATH = "/home/u1755025/FedMPEN_mycode/output"
    _C.MODEL.STORE_TP_FP_FN_FILE_NAME = "FedAvg"
    _C.MODEL.EVAL_OVTHRESH = 50
